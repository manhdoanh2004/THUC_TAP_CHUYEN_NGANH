...
export const SearchContainer = () => {
  ...
  useEffect(() => {
    fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/jobs/search? language=${language}&location=${city}&company=${company}&keyword=${keyword}&position=${position}&workingForm=${workingForm}&page=${page}&salaryRange`)
      .then(res => res.json())
      .then(data => {
         setJobList(data);
